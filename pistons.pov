...
#declare piston = merge{
    ...
    difference{
        union{
            object{piston_head translate<0, 25, 0>}
            merge{
                cylinder{<0,80,0>,<0,-60,0>,15}
                merge{
    ...
    object{piston_finger translate<0, 25, 0>}
